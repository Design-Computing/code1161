  ...
  //'ID',                 'Parent',                   'Mark','colour', 'Quick description',                                     'full description link', 'start date',     'Submission Date',      'Full Name',      'Duration',   'Week',  'Dependencies', in gantt   in tree
   ...
   ['Semester',           null,                         null, null, "This is just a time period, admittedly an important one!","http://awebsite.com",    week( 1,'Monday'), week(16,'Friday'),        "Semester period", null,         1,             null,          true,    true],
      ...
      ['Software + Machine Learning',         'Semester',                    15, null, "A real life programming task with machine learning",                   "http://awebsite.com",    week( 7,'Tuesday'), week( 9,'Friday'),        "nice name",       7-9,         0,             null,          true,    true],
        ...
        ['Creativity',           'Software + Machine Learning',         15/100*33, null, "State both sides of the argument",                       "http://awebsite.com",    week( 7,'Tuesday'), week( 9,'Friday'),        "nice name",       null,         0,             null,          false,   true],
        ['Execution',  'Software + Machine Learning',         15/100*34, null, "Explain your position now",                              "http://awebsite.com",    week( 7,'Tuesday'), week( 9,'Friday'),        "nice name",       null,         0,             null,          false,   true],
      ['Exam',              'Semester',                    10, null, "Programming questions, under pressure",                  "http://awebsite.com",    week( 5,'Tuesday'), week( 5,'Tuesday', 13),    "nice name",       null,         0,             null,          true,    true],
      ...
      ['Weekly Tasks',      'Semester',                 17  , null, "Problems to check that you are understanding things",    "http://awebsite.com",    week( 1,'Tuesday'), week( 7,'Friday'),        "nice name",       null,         0,             null,          true,    true],
        ['week 1',            'Weekly Tasks',           17/6, null, "confirm that everything is working",                     "http://awebsite.com",    week( 1,'Tuesday'), week( 2,'Monday', 19), "nice name",       null,         0,             null,          true,    true],
        ['week 2',            'Weekly Tasks',           17/6, null, "Linting, syntax, loops",                                 "http://awebsite.com",    week( 2,'Tuesday'), week( 3,'Monday', 19), "nice name",       null,         0,             'week 1',      true,    true],
        ['week 3',            'Weekly Tasks',           17/6, null, "More loops, a game, and a game that plays itself",       "http://awebsite.com",    week( 3,'Tuesday'), week( 4,'Monday', 19), "nice name",       null,         0,             'week 2',      true,    true],
        ['week 4',            'Weekly Tasks',           17/6, null, "Reading and writing files, and the internet",            "http://awebsite.com",    week( 4,'Tuesday'), week( 5,'Monday', 19), "nice name",       null,         0,             'week 3',      true,    true],
        ['week 5',            'Weekly Tasks',           17/6, null, "Recursion and refactoring",                              "http://awebsite.com",    week( 5,'Tuesday'), week( 6,'Monday', 19), "nice name",       null,         0,             'week 4',      true,    true],
        ['week 6',            'Weekly Tasks',           17/6, null, "Data cleaning and manipulation",                         "http://awebsite.com",    week( 7,'Tuesday'), week( 8,'Monday', 19), "nice name",       null,         0,             'week 5',      true,    true],
  ];
